...
('4a5f4c6f77b8268f19e37e7679082019753f12457d7258dfcfbf10d8a93298de4b1db83c9969959e',8,1,'MyApp','[]',0,'2024-06-03 19:28:54','2024-06-03 19:28:54','2025-06-03 19:28:54'),
...
('acd119006711179460050c62024a71857d529bc01278520b81245cd5e4100bb82b9c7b6f8e9393bc',8,1,'MyApp','[]',0,'2024-06-02 14:23:22','2024-06-02 14:23:22','2025-06-02 14:23:22'),
('b1c9d24449e38e6302f45fe005bbdde3ffa48ab0a4de008d33f5b06dc24fcb476ce1fe73bad3f5b7',9,1,'MyApp','[]',0,'2024-05-25 17:39:05','2024-05-25 17:39:05','2025-05-25 17:39:05'),
...
('f7d0870c9e41f79341dc558fadfccbc3c714424dde7fc0f705ec11cf30d1fbf8967dd0758a54a988',8,1,'MyApp','[]',0,'2024-05-25 17:38:09','2024-05-25 17:38:09','2025-05-25 17:38:09'),
...
CREATE TABLE `ts_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1011027 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1011025,'Test22',1,'8','2024-05-25 17:43:14','sss','sss'),
(1011026,'Test22',1,'8','2024-05-25 18:01:08','sss','sss');
...
CREATE TABLE `ts_sales` (
  ...
  `stock_id` bigint(10) DEFAULT NULL,
  `item_id` bigint(10) DEFAULT NULL,
  `meas_unit` varchar(10) DEFAULT NULL,
  ...
  `others` varchar(10) DEFAULT '0',
  `pay_status` varchar(10) DEFAULT '0',
  `status` int(2) DEFAULT 0,
  `create_by` varchar(10) DEFAULT '0',
  `create_date` varchar(20) DEFAULT '0',
  `update_by` varchar(10) DEFAULT '0',
  `update_date` varchar(20) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `ts_sales` */

insert  into `ts_sales`(`id`,`invoice_no`,`stock_id`,`item_id`,`meas_unit`,`qty_unit`,`meas`,`qty`,`price`,`vat`,`tax`,`discount`,`others`,`pay_status`,`status`,`create_by`,`create_date`,`update_by`,`update_date`) values 
(1,'W2030',3,1071001,'CM','CTN','8650','20','960','50','30','100','10','Paid',1,'8','2024-06-04 18:55:12','0','0'),
(2,'W20230',3,1071001,'CM','CTN','8650','200','9850',NULL,NULL,NULL,NULL,'Due',1,'8','2024-06-04 18:56:06','0','0'),
(3,'W20230',3,1071001,'CM','CTN','8650','200','9850',NULL,NULL,NULL,NULL,'Paid',1,'8','2024-06-04 18:56:15','8','2024-06-04 18:58:13');

/*Table structure for table `ts_stock` */

DROP TABLE IF EXISTS `ts_stock`;

CREATE TABLE `ts_stock` (
  `id` bigint(10) NOT NULL AUTO_INCREMENT,
  `stock_code` varchar(36) DEFAULT 'null',
  `item_id` bigint(10) DEFAULT 0,
  `meas_unit` varchar(10) DEFAULT '0',
  `qty_unit` varchar(10) DEFAULT '0',
  `meas` varchar(10) DEFAULT '0',
  `qty` varchar(10) DEFAULT '0',
  `sell_price` varchar(10) DEFAULT '0',
  `buy_price` varchar(10) DEFAULT '0',
  `status` varchar(5) DEFAULT '0',
  `create_by` varchar(20) DEFAULT 'null',
  `create_date` varchar(36) DEFAULT 'null',
  `update_by` varchar(20) DEFAULT 'null',
  `update_date` varchar(20) DEFAULT 'null',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `ts_stock` */

insert  into `ts_stock`(`id`,`stock_code`,`item_id`,`meas_unit`,`qty_unit`,`meas`,`qty`,`sell_price`,`buy_price`,`status`,`create_by`,`create_date`,`update_by`,`update_date`) values 
(1,'W2030-103B',1071000,'CM','CTN','8650','50','300','250','3','8','2024-06-02 19:12:52','8','2024-06-04 18:05:17'),
(2,'W2030-103BRD',1071000,'CM','CTN','8650','50','300','250','3','8','2024-06-02 19:16:08','8','2024-06-04 18:15:20'),
(3,'W2030-103BRD',1071001,'CM','CTN','8650','50','300','250','1','8','2024-06-02 19:16:32','null','null'),
(4,'W2030-103BRD',1071001,'CM','CTN','8650','50','300','250','1','8','2024-06-02 19:16:57','null','null'),
(5,'W2030-103BRD',1071002,'CM','CTN','8650','50','300','250','1','8','2024-06-03 19:29:40','null','null'),
(6,'W2030-103BRD',1071002,'CM','CTN','8650','20','300','250','1','8','2024-06-03 19:29:46','null','null'),
(7,'W2030-103BRD',1071002,'CM','CTN','8650','20','300','250','1','8','2024-06-03 19:34:54','8','2024-06-04 17:05:05'),
(8,'W2030-103BRD',1071002,'CM','CTN','8650','20','300','250','1','8','2024-06-04 17:19:57','null','null');
...
CREATE TABLE `ts_subcategory` (
  ...
  `update_date` varchar(36) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1012013 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1012012,1011004,'Dummy',1,'8','2024-05-25 18:10:32','1','1');
...
(8,'Dhali Abir','dhaliabir@gmail.com',NULL,1,'$2y$10$pUR5t7XmBVPVOkcWrqfezO6x048Zo82RfO6cOgWpHcKNJxciW/lYa',NULL,'2024-05-24 11:42:12','2024-05-24 11:42:12'),
(9,'Ashif Dhali','ashif@gmail.com',NULL,1,'$2y$10$OsJ8ofUGzdW4r93VKjMfyeDstZaX2WGMo1B7l/2A5i5TIHv7pfZzi',NULL,'2024-05-25 17:39:05','2024-06-02 14:56:13');
